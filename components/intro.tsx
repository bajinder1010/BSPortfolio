...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-extrabold tracking-wide  text-5xl text-[#f6f9fc]">
          Hello, I&apos;m Bajinder Singh
        </span>
        <div className="text-3xl py-1  leading-snug text-[#8ea9bf]">
          Senior Software Engineer currently based in London,UK. My professional
          journey includes collaborating with clients worldwide, contributing to
          a global perspective in software development. I develop things in my
          free time.
        </div>
      </motion.h1>
